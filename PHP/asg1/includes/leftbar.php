<nav class="ts-sidebar">
	...
	<li><a href="registration.php"><i class="fa fa-files-o"></i>Register User</a>
		<!-- <ul>
			<li><a href="create-brand.php">Create Design</a></li>
			<li><a href="manage-brands.php">Manage Design</a></li>
		</ul> -->
	</li>
	<!-- <li>
		<a href="profile.php"><i class="fa fa-file-o"></i>Profile</a>		
	</li> -->

	<!-- <li><a href="#"><i class="fa fa-car"></i> Design</a>
		<ul>
			<li><a href="post-avehical.php">Post a Design</a></li>
			<li><a href="manage-vehicles.php">Manage Design</a></li>
		</ul>
	</li>
